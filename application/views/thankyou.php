...
<section class="ecs_form_main">
     You have chosen to courier the ECS Mandate by yourself. Please send us the signed copy of ECS Mandate for Account XXXXXXXX<?=substr(trim(@$investor_data->accountNumber, " "), -3, 3)?>  of <?=@$investor_data->bankName?> within three working days to the following address:
     <br>
     Aditya Birla Customer Services Limited, Unit No: 506, B-Wing, Cello Triumph Building, I B Patel Road, Off W.E. Highway, Goregaon (East), Mumbai- 400 063.
</section>
