...
<link href="<?=base_url()?>assets/css/logout/font.css?v=22" type="text/css" rel="stylesheet">
...
<section class="ecs_form_main">
    ...
    <div class="ecs_inner" id="step2">
        ...
        <div class="form_field">
			...
			<input type="text" id="state" name="state" readonly value="" class="text_box1 wid1" placeholder="State" required />
            <!--<label>
        ...
        <div class="form_field">
        	<label>
                <dl class="dropdown">
                    ...
                    <dd>
                        <ul>
                            <li><a class="">10.00 To 10.30</a></li>
                            <li><a>10.30 To 11.00</a></li>
                            <li><a>11.00 To 11.30</a></li>
                            <li><a>11.30 To 12.00</a></li>
                            <li><a>12.00 To 12.30</a></li>
                            <li><a>12.30 To 01.00</a></li>
                            <li><a>01.00 To 01.30</a></li>
                            <li><a>01.30 To 02.00</a></li>
                            <li><a>02.00 To 02.30</a></li>
                            <li><a>02.30 To 03.00</a></li>
                            <li><a>03.00 To 03.30</a></li>
                            <li><a>03.30 To 04.00</a></li>
                            <li><a>04.00 To 04.30</a></li>
                            <li><a>04.30 To 05.00</a></li>
                            <li><a>05.00 To 05.30</a></li>
                            <li><a>05.30 To 06.00</a></li>
                        </ul>
                    </dd>
                </dl>
			</label>
    ...
    <div class="ecs_inner" id="step3">
        ...
        <div class="line_grey"></div>
        <p><span id="date_time">30th-Feb-2015</span> at <span id="pickup_time">10:00AM to 10:30AM</span> <span id="day"></span>  </p>
...
copy of <?php if(@$bank_details){ echo @$bank_details['0']->bankName; }?> (XXXXXXXX<?=substr(trim(@$bank_details['0']->accountNumber, " "), -3, 3)?>)</p>
        <div class="note">
        	<ol type="1">
                ...
                <li>Please call our customer care at <a href="tel:022-6167565656" class="back_link2">022-6167565656</a></li>
            </ol>
		</div>
      <!--  <div class="form_field form_field1">
...
$(document).ready(function(e) {
  ...
  var keep_alive_timer = setInterval(function(){
	...
	$('#step1_next').click(function(e) {
		...
		if(user_session_email!=="" && user_session_pin!==""){
			swal({   
      title: "Are you sure?",   
