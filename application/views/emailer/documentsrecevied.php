    ...
    <tr>
      <td><table width="600" align="center" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #b8b8b8; border-bottom:0; background-color:#fff; font-size:14px; font-family: Arial, Helvetica, sans-serif; color:#444444; line-height:18px;">
          <tbody>
            ...
            <tr>
              <td align="center"><img src="<?=base_url()?>assets/emailer_images/receivedbg.jpg" width="600" height="181" alt="EKYC "></td>
            </tr>
            <tr>
              <td height="20"></td>
            </tr>
            <tr>
              <td><table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
                  ...
                  <tr>
                    <td>This is to inform you that your Mandate was processed by My Universe and was found to be meeting all the required criteria. We will be forwarding this to <strong><?=$investor_data->bankName?></strong> who will perform additional checks and revert whether it was accepted or rejected</td>
                  </tr>
                  <tr>
                    <td height="20"></td>
                  </tr>
