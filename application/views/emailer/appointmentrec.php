...
<table width="650" border="0" cellspacing="0" cellpadding="0" bgcolor="#d3d3d3" align="center">
  <tbody>
    <tr>
      <td><table width="600" align="center" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #b8b8b8; background-color:#fff; font-size:14px; font-family: Arial, Helvetica, sans-serif; color:#444; line-height:18px;">
          <tbody>
            <tr>
            ...
            <tr>
              <td align="center"><img src="<?=base_url()?>assets/emailer_images/banner.jpg" width="600" height="181" alt="EKYC "></td>
            </tr>
            <tr>
              <td height="30"></td>
            </tr>
            <tr>
              <td><table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                    <td><strong>Dear <?=$investor_data->name?>,</strong>
                    </td>
                  </tr>
                  <tr>
                  <td height="10"></td>
                  ...
                  <tr>
                  <td>
                    We have received your request for pickup of documents related to your My Universe Investment Account. Our representative will be at your home at the below given address.</td>
                  </tr>
                  <tr>
                    <td height="20"></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td colspan="2"><strong> Please keep the list of documnets duly signed and hand it over to our representative.</strong></td>
                        </tr>
                  ...
                  <tr>
                    <td> For your convenience we have also attached a PDF of the mandate that needs to
                      be handed over in this email. </td>
                  </tr>
                </table></td>
            </tr>
            <tr>
            ...
            <tr>
              <td ><table width="90%" border="0" cellspacing="0" cellpadding="0" align="center" sty>
                  <tr>
            ...
            <tr>
              <td style="padding-top:15px"><table width="90%" border="0" cellspacing="0" cellpadding="0" style="color:#444" align="center">
                  <tr>
            ...
            <tr>
              <td style="text-align:center"><strong>MISSED THE PICKUP GUY? NO WORRIES </strong></td>
            </tr>
            <tr>
