    ...
    <tr>
      <td><table width="600" align="center" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #b8b8b8; border-bottom:0; background-color:#fff; font-size:14px; font-family: Arial, Helvetica, sans-serif; color:#444444; line-height:18px;">
          <tbody>
            ...
            <tr>
              <td align="center"><img src="<?=base_url()?>assets/emailer_images/Outbg.jpg" width="600" height="181" alt="EKYC "></td>
            </tr>
            <tr>
              <td height="20"></td>
            </tr>
            <tr>
              <td><table width="90%" border="0" cellspacing="0" cellpadding="0" align="center" style="margin-top:15px">
                  <tr>
                  ...
                  <tr>
                  <td>Our document pickup representative is on his way, please keep the list of documents duly signed and ready.</td>
                  </tr>
                </table></td>
            </tr>
            <tr>
            ...
            <tr>
              <td><table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
                  ...
                  <tr>
                    <td colspan="3" style="text-align:center"><strong>LIST OF DOCUMENTS</strong></td>
                  </tr>
                  
                  <tr>
                    <td style="text-align:center" valign="top" height="15"><img src="<?=base_url()?>assets/emailer_images/black-line.jpg" width="23" height="1"></td>
                  </tr>
                   <tr>
                    <td colspan="3" height="15"></td>
                  </tr>
                  <tr>
                    <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="color:#8f8f8f">
                        <tr>
