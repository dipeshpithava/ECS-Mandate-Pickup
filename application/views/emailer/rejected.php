...
<table width="650" border="0" cellspacing="0" cellpadding="0" bgcolor="#d3d3d3" align="center">
  <tbody>
    <tr>
      <td><table width="600" align="center" border="0" cellspacing="0" cellpadding="0" style="border:1px solid #b8b8b8; border-bottom:0; background-color:#fff; font-size:14px; font-family: Arial, Helvetica, sans-serif; color:#444444; line-height:18px;">
          <tbody>
            ...
            <tr>
              <td align="center"><img src="<?=base_url()?>assets/emailer_images/rejectedbg.jpg" width="600" height="181" alt="EKYC "></td>
            </tr>
            <tr>
              <td height="20"></td>
            </tr>
            <tr>
              <td><table width="90%" border="0" cellspacing="0" cellpadding="0" align="center">
                  ...
                  <tr>
                    <td>This is to inform you that your Mandate was rejected by your bank because <Reason for Failure> We request you to make the necessary corrections and reschedule a new Pickup by clicking. <a href="https://stg.adityabirlamoneyuniverse.com/schedule-ecs-pickup" style="color:#2c54bd">Reschedule Mandate Pickup</a></td>
                  </tr>
                  <tr>
                    <td height="20"></td>
                  </tr>
   ...
   <tr>
   <td>
   <table width="600" border="0" cellspacing="0" cellpadding="0" align="center" style="">
   <tr>
