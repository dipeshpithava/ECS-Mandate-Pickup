    ...
    <header class="header">
      ...
      <nav class="mobile-hide">
        <ul class="naviagationLink">
          <li><a href="tel:022-61802828"><img src="<?=base_url()?>assets/images/call.png" /> 022-61802828 (10am-7pm Mon - Sat)</a></li>
        </ul>
      </nav>
    </header>
    <div class="clear"></div>
...
<footer class="mobile-hide">
  <div class="footerCont">
    <div class="footer-ico"><a href="https://stg.adityabirlamoneyuniverse.com/sitepages/homepage.aspx"><img src="<?=base_url()?>assets/images/footer_abmu_logo.png"></a></div>
