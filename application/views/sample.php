<div class="small_note">INV User ID: <?=$this->session->userdata("investor_id")?> \ Version no: <?=$investor_details->versionNo?></div>
...
<!--     <img src="assets/images/ABM_MyUniverse_Logo.jpg" style="width:200px; vertical align">
    ...
    <img src="assets/images/logo_banner.png?v=gjsfh" style="width:100%;" alt="image1">
</div>
...
<div class="investor panel margin_b_3">
	...
	<div class="panel">
		<table width="100%">
			<tr>
				<td class="font_b">Investor ID: <input type="text" value="<?=$investor_details->invuser_id?>" class="w-80"></td>
				<td class="font_b">Contact Email Id: <input type="text" value="<?=$investor_details->myUniverseEmailId?>" name="" class="w-80"></td>
			</tr>
...
<div class="bank_info panel">
	<table width="100%">
		<tr>
			<td colspan="3" class="">First Applicant Account Holder Name: <input type="text" value="<?=$investor_details->accHolderName?>" class="w-80"></td>
		</tr>
	
		<tr>
			<td colspan="2" class="">Bank Name: <span style="display:inline-block; margin-left:5px; border-bottom:1px solid black; font-size:8px;" class="w-80"><?=$investor_details->bankName?></span></td>
			<td class="">Account No: <span style="display:inline-block; margin-left:5px; border-bottom:1px solid black; font-size:8px;" class="w-70"><?=$investor_details->accountNumber?></span></td>
		</tr>
		
		<tr>
			<td class="">Account Type: <span  style="display:inline-block; margin-left:5px; border-bottom:1px solid black; font-size:8px;" class="w-60"><?=$investor_details->accountType?></span></td>
			<td class="">IFSC Code: <span  style="display:inline-block; margin-left:5px; border-bottom:1px solid black; font-size:8px;"  class="w-60"><?=$investor_details->ifscCode?></span></td>
			<td class="">MICR Code: <span  style="display:inline-block; margin-left:5px; border-bottom:1px solid black; font-size:8px;"  class="w-70"><?=$investor_details->micrCode?></span></td>
		</tr>
		
		<tr>
			<td colspan="3" class="">Branch address: <span style="display:inline-block; margin-left:5px; border-bottom:1px solid black; font-size:8px;" class="w-90"><?=$investor_details->bankAddress?></span></td>
		</tr>
...
<div style="height:40px; background:#c51c2c;" class="red_header_box panel">
    <center><img src="assets/images/band.jpg" style="width:80%;" alt="image2" /></center>
</div>
