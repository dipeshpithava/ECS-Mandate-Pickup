...
<section class="ecs_form_main">
    ...
    <div class="ecs_inner" id="step1">
        ...
        <div class="form_field">
        	<input type="text" class="text_box1" name="pin" id="pin" value="<?php if(@$user_data['0']->pincode!=""){echo $user_data['0']->pincode;}?>" placeholder="Pincode of the pick-up location" required />
        	...
        	<ol type="1">
                <li>
                  ...
                  if(@$bank_details['0']->bankName!=""){
                    ?>
                    <a href="<?=base_url()?>pdf" target="_blank" class="back_link2">Download your ECS mandate,</a>
