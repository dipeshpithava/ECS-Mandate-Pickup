            ...
            <hr>
              ...
              <div class="col-lg-12">
                <table cellspacing="0" id="display_table">
                    <tr>
						<td>Investor Id</td>
						<td><?=$all_investors->investor_user_id?></td>
					</tr>
					<tr>
						<td>Investor Name</td>
						<td><?=$all_investors->investor_name?></td>
					</tr>
					<tr>
						<td>Account Status</td>
						<td><?=$all_investors->account_status?></td>
					</tr>
					<tr>
						<td>Investor DOB</td>
						<td><?=$all_investors->investor_dob?></td>
					</tr>
					<tr>
						<td>Bank Name</td>
						<td><?=$all_investors->bank_name?></td>
					</tr>
					<tr>
						<td>Bank Account No</td>
						<td><?=$all_investors->bank_account_no?></td>
					</tr>
					<tr>
						<td>Emai ID</td>
						<td><?=$all_investors->myuniverse_email_id?></td>
					</tr>
